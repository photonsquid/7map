...
public class Color {
   ...
   /**
    * Create a new color : - Hexa color: begins with a '#', case insensitive. Ex:
    * #8E44AD #1abc9c - rgb color: begins with a 'rgb', then 3 values in
    * parenthesis, separated with coma. Ex: rgb(41, 128, 185) rgb(0.75, 0.22, 0.17)
    * - hsl color: begins with a 'hsl', then 3 values in parenthesis, separated
    * with coma: - hue from 0 to 360 - saturation : from 0 to 100 with % symbol at
    * the end - lightness : from 0 to 100 with % symbol at the end Ex: hsl(37, 90%,
    * 51%)
    * 
   ...
   // Color rgbfStringColor = new Color("rgb(0.75, 0.22, 0.17)"); // excpected:
   // rgb(192, 57, 43)
   ...
   // System.out.println("\"rgb(0.75, 0.22, 0.17)\" => " +
   // rgbfStringColor.toString());
